<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIIS.aspx.cs" Inherits="StudentAdvisingSystem.GIIS" %>
...
<div id="header" class="noprint">
    ...
    <div id="main"><!--main-->
      ...
      <div id="mainhomecontent">  <!-- start mainhomecontent -->
           <h1>Welcome to the School of Graduate, International, and Interdisciplinary Studies (GIIS)</h1>
           <h3>Please select the office you are looking for.</h3>
           <br />
           <ul><li><asp:HyperLink ID="GIISGRAD" runat="server" Text="Graduate School" NavigateUrl="https://em.csuchico.edu:444/aap/StudentAdvisingSystem/SAS.aspx?dept=GIISGRAD" /></li>
            <li><asp:HyperLink ID="BUSGRAD" runat="server" Text="College of Business Graduate Advising Office" NavigateUrl="https://em.csuchico.edu:444/aap/StudentAdvisingSystem/SAS.aspx?dept=BUSGRAD" /></li>
            <li><asp:HyperLink ID="ECCEECE" runat="server" Text="Electrical & Computer Engineering" NavigateUrl="https://em.csuchico.edu:444/aap/StudentAdvisingSystem/SAS.aspx?dept=ECCEECE" /></li>
            <li><asp:HyperLink ID="BSSSWRK" runat="server" Text="Social Work" NavigateUrl="https://em.csuchico.edu:444/aap/StudentAdvisingSystem/SAS.aspx?dept=BSSSWRK" /></li>
           </ul>
            <br />
    ...
    <div id="footeraddress"><!-- start footeraddress -->
            <p>Academic Advising Programs <br />
			  ...
			  <p>Our office is located in SSC 120</p>
